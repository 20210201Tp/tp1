		...
		<div class="w3-bar w3-black w3-card">
			...
			<div class="w3-dropdown-hover w3-hide-small">
				<button class="w3-padding-large w3-button" title="More">
					목 록<i class="fa fa-caret-down"></i>
				</button>
			...
			<c:if test="${not empty vo.memberAuth}">
				<div class="w3-dropdown-hover w3-hide-small">
					<button class="#" title="More">
						도서목록<i class="fa fa-caret-down"></i>
					</button>
					<div class="w3-dropdown-content w3-bar-block w3-card-4">
						<a href="#" class="w3-bar-item w3-button">도서관리</a> <a href="#"
							class="w3-bar-item w3-button">도서등록</a> <a href="#"
